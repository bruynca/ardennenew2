...
public class WinCardInHandDisplay {
    Window window;
    Stage stage;
    Label label;
    Table table;
     ...
     *
     */
    public WinCardInHandDisplay(){
        isAllies = NextPhase.instance.isAlliedPlayer();
        ...
        if (arrCardToChoose.size() == 0){
            EventPopUp.instance.show(i18NBundle.format("nocards"));
            return;
        }
    ...
    private void initializeWindow() {
        ...
        String title = i18NBundle.format("cardhand");
    ...
    private void setCloseWindowImage() {
        ...
        hitOK = new TextTooltip(
                i18NBundle.format("endcarddisplay"),
                tooltipStyle);
