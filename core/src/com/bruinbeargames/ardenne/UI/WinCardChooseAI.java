...
import com.bruinbeargames.ardenne.AI.AICardHandler;
...
public class WinCardChooseAI implements Observer {
    Window window;
    Stage stage;
    Label label;
    Table table;
     ...
     * @param cardIn
     */
    public WinCardChooseAI(boolean isAllies, ArrayList<CardsforGame> arrValidCards, CardsforGame cardIn){
        Gdx.app.log("WinCardsChooseAI", "Constructor allied="+isAllies);
        cardChosen = cardIn;
        arrCardToChoose.addAll(arrValidCards);
        i18NBundle = GameMenuLoader.instance.localization;
        this.isAllies = isAllies;
        initializeWindow();
//        setCloseWindowImage(); not used
        ...
        EventOK.instance.show(i18NBundle.format("aiplaycard"));
...
//        Gdx.app.log("WinCardsChoice", "initcards str="+strTip);
        ...
        /**
         * create touchups don use for AI
         */
    ...
    public void update(Observable observable, Object o) {
        ...
        if (((ObserverPackage) o).type == ObserverPackage.Type.OK){
            ...
            Timer.schedule(new Timer.Task() {
                               @Override
                               public void run() {
                                   Gdx.app.log("WinCardChoosdeAI", "Playing Next" );
                                   AICardHandler.instance.playCard(cardChosen);
                               }
